...
3. **run_sm_counter** - Use the "smCounter" variant calling procedure, decribed here:
...
#### metrics
This package contains auxiliary modules that provide read accounting and and enrichment summary metrics such as uniformity and fragment length distribution.
